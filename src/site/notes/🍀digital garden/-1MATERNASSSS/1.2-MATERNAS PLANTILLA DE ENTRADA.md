...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Títulos ultra pequeños aguamarina - TAMAÑO REDUCIDO */
    h1, h2, h3, h4, h5, h6 {
      margin: 0 0 2px 0;
      font-weight: 500;
    ...
    /* Opciones super compactas en negro - TAMAÑO REDUCIDO */
    label {
      display: flex;
      align-items: center;
      margin: 1px 0;
    ...
    /* Checkbox aguamarina sobre negro - TAMAÑO REDUCIDO */
    input[type="checkbox"] {
      margin-right: 3px;
      width: 12px;
      height: 12px;
    ...
    /* Botón negro con aguamarina - TAMAÑO REDUCIDO */
    button {
      background: #0a1212;
      color: #aaffff;
    ...
    /* Resultado con fondo negro - TAMAÑO REDUCIDO */
    #resultado {
      margin-top: 8px;
      padding: 8px;
      border-radius: 12px;
    ...
    /* Media query para móvil - TAMAÑOS AÚN MÁS REDUCIDOS */
