---
{"dg-publish":true,"permalink":"/digital-garden/dengue-comp/ea-dengue/","dgPassFrontmatter":true}
---
...
<label><input type="checkbox" onclick="updateNarrativa()">ES TRAIDO AL SERVICIO DE URGENCIAS POR MADRE QUIEN REFIERE QUE HA PRESENTADO </label><br>
...
function updateNarrativa() {
  ...
  if (checks[20].checked) narrativa += "DEPOSICIONES MELENICAS ";
  if (checks[20].checked) narrativa += "EMATEMSIS ";
